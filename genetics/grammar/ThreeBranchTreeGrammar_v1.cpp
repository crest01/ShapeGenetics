...
void ThreeBranchTreeGrammar_v1::initSymbols(SymbolManager& sm)
{
...
int ThreeBranchTreeGrammar_v1::storeParameter(Symbol* symbol, PGG::Parameters::ParameterTable& pt)
{
...
int ThreeBranchTreeGrammar_v1::storeTrunkParameter(Symbol* s, PGG::Parameters::ParameterTable& pt)
{
	int branch[3] = {0};
	...
	math::float2 pos2 = s->getParameter()[1]->getValue<math::float2>();
	math::float3 pos(pos2.x, 0, pos2.y);
...
int ThreeBranchTreeGrammar_v1::storeBranchParameter(Symbol* s, PGG::Parameters::ParameterTable& pt)
{
	int branch[3] = {0};
	int branch_offset[3] = {0};
	for (int i = 0; i < s->getChildren().size(); ++i) {
...
void ThreeBranchTreeGrammar_v1::createAxiom(PGG::CPU::GrammarSystem& system, const int axiomId)
{
	...
	class Tree : public
		Translate<DynamicFloat3<12, ParamLayer>, DirectCall<
...
//	class BranchRecursion : public
//		DirectCall< Duplicate< DirectCall< ChoosePath< LogialNot<LogicalAnd<DynamicInt< 8, ParamLayer>, DynamicInt< 10, ParamLayer> > >,
//											 SetScopeAttachment<ParamLayer, DynamicInt<9, ParamLayer>, StaticCall<GenerateBranchRule> >,
//											 StaticInt<1>, StaticCall<GenerateLeaf1Rule> > >,
//		                       DirectCall< ChoosePath< DynamicInt< 10, ParamLayer>,
//											 SetScopeAttachment<ParamLayer, DynamicInt<11, ParamLayer>, StaticCall<GenerateBranchRule> > > >,

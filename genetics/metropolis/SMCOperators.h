...
#ifndef GPUPROCGENETICS_SRC_SMC_OPERATORS_H_
#define GPUPROCGENETICS_SRC_SMC_OPERATORS_H_
...
class SMCSelection: public Selection_IF
{
...
private:
	...
	float			_sum_fitness;
public:
	SMCSelection(ProceduralAlgorithm* base):
		_algo(base)
	{}
...
class SMCGrowMutation: public Mutation_IF {
private:
	ProceduralAlgorithm* _algo;
	MutationConf*  	_conf;
	GenomeConf* 	_genomeConf;

public:
	SMCGrowMutation(ProceduralAlgorithm* base):
		_algo(base)
	{ }
	~SMCGrowMutation() {}
...
#endif /* GPUPROCGENETICS_SRC_SMC_OPERATORS_H_ */

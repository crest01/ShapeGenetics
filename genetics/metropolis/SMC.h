...
#ifndef GPUPROCGENETICS_SRC_SMC_H_
#define GPUPROCGENETICS_SRC_SMC_H_
...
class SMCAlgorithm : public GeneticAlgorithm_IF
{
...
public:
	SMCAlgorithm(ProceduralAlgorithm* base):
		_algo(base),
		_total_time(0.0),
		_generation(0)
	{}
...
#endif /* GPUPROCGENETICS_SRC_SMC_H_ */
